        ...
        <div class="col-xs-10 col-sm-10 col-md-10">
            ...
            <div class="row zczt">
                <div class="col-xs-offset-1 col-xs-5" id="regist_1">
                    <div class="row zczt">
                        创建Weplay账户名称：<br/>
                        <input class="inputcolor" type="text" id="yonghuming"><br/></div>
                    <div class="row zczt">
                        请输入昵称：<br/>
                        <input class="inputcolor" type="text" id="nichen"><br/></div>
                    <div class="row zczt">
                        请输入密码：<br/>
                        <input class="inputcolor" type="password" id="password"><br/></div>
                    <div class="row zczt">
                        请输入邮件地址：<br/>
                        <input class="inputcolor" type="text" id="email"><br/>Weplay 将向此帐户发送一封用于确认的电子邮件。请通过邮件中的验证码验证您的
                        Weplay 电子邮件帐户。
                    </div>
                    <div class="row zczt">
                        请输入您的手机号:<br/>
                        <input class="inputcolor" type="text" id="phone"><br/></div>
