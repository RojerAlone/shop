    ...
    <div class="col-xs-10 col-sm-10 col-md-10">
      ...
      <div class="row zczt" >
		<div class="col-xs-offset-1 col-xs-5" id="regist_2">
            <div class="row zczt">
            输入您的验证码：<br />
            <input class="inputcolor" type="text" id="code"><input type="button"  class="btnsz" value="重新发送邮件" style="background-color:#417a9b;" onclick="time(this)"></div>
                <div class="form-group">
					<div class=" col-sm-10">
						 <button type="submit" class="btn btn-default" style="background-color:#417a9b;" onclick="zhuce()">确定</button>
					</div>
				</div>
			</div>	
