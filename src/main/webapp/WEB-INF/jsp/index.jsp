      ...
      <div class="col-xs-10 col-sm-10 col-md-10">
        ...
        <div class="row">
          <div id="carousel_1" class="carousel slide" data-ride="carousel">
            ...
            <!-- Controls -->
            <a class="left carousel-control" href="#carousel_1" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">Previous</span> </a>            <a class="right carousel-control" href="#carousel_1" role="button" data-slide="next"> <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span class="sr-only">Next</span> </a>            </div>
        </div>
        <div class="row">
          ...
          <div class="col-xs-8 col-sm-8 col-md-8">
            ...
            <div id="myTabContent" class="tab-content" ;>
              <div class="tab-pane fade in active" id="home">
                <div class="row rowpy"><a href="#"><img src="./img/static/zx_1.png"  onmouseover="hoverShowDiv(1);" ></a></div>
                <div class="row rowpy"><a href="#"><img src="./img/static/zx_2.png"  onmouseover="hoverShowDiv(2);" ></a></div>
                <div class="row rowpy"><a href="#"><img src="./img/static/zx_3.png"  onmouseover="hoverShowDiv(3);" ></a></div>
                <div class="row rowpy"><a href="#"><img src="./img/static/zx_9.png"  onmouseover="hoverShowDiv(9);" ></a></div>
                <div class="row rowpy"><a href="#"><img src="./img/static/zx_10.png"  onmouseover="hoverShowDiv(10);" ></a></div>
                <div class="row rowpy"><a href="#"><img src="./img/static/zx_11.png"  onmouseover="hoverShowDiv(11);" ></a></div>
              </div>
