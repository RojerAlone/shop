...
<div class="row mar" align="center">
	<input type="button" onclick="show_confirm()"  class="btn btn-default btn-lg" style="width:80;height:30" value="支付" />
</div>   
</div>
<div class="col-xs-2">
</div>
...
当您完成此笔交易后，我们将向您发送一封电子邮件来确认购物收据。</h4></tr>
    ...
    <tr><h4 style="color:#FFF">该过程可能会长达 60 秒。为了避免购买失败，在交易结束前请不要点击后退按钮或关闭支付宝窗口。</h4></tr>
</table>
</div>
</div>
</div>
