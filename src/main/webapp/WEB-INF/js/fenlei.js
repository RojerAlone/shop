    ...
    function () {
        ...
        $.post(url, function (result) {
            ...
            while (result.data[k]) {
                ...
                li.innerHTML = u + "'><div class='row fenleizitiyanse jutiyouxi'><div class='col-md-4'><img id='xianshitupian_" + k + "'onmouseover='xianshitupian(" + k + ")'" + "onmouseout='yingcangtupian(+" + k + ")' src='/img" + result.data[k].img[0] + "' class='imgdx_1'></div><div class='col-md-8'><div class='row youximingzi'>" + result.data[k].name + "</div><div class='row'><div class='col-md-2 col-md-offset-10'>" + prices[k] + "</div></div><div class='row youximingzi' id='tags_" + k + "'></div></div></div>"
