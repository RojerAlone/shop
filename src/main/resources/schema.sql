...
CREATE TABLE IF NOT EXISTS `shop`.`user` (
  ...
  `success` TINYINT NOT NULL DEFAULT 0 COMMENT '用户状态，0为正常，1为未验证，2为受限，3为删除' ,
  PRIMARY KEY (`id`)
...
--  `tags` VARCHAR(100) NOT NULL COMMENT '标签，用逗号分隔开' ,
  ...
  `success` TINYINT NOT NULL DEFAULT 0 COMMENT '状态，0为未上架，1为已上架，2为已下架' ,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `shop`.`code` (
  ...
  `success` TINYINT NOT NULL DEFAULT 0 COMMENT '激活码状态，0表示未使用，1表示已使用',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `shop`.`order` (
  ...
  `ctime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间' ,
  `utime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间' ,
  `success` TINYINT NOT NULL DEFAULT 0 COMMENT '订单状态，0为未支付，1为已支付，2为取消订单' ,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `shop`.`validatecode` (
  `uid` INT NOT NULL COMMENT '用户ID',
  `code` VARCHAR(36) NOT NULL COMMENT 'UUID',
  `ctime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间'
) ENGINE = InnoDB DEFAULT CHARSET = UTF8 COMMENT '用户注册时的注册码';